...
function getLodop(oOBJECT, oEMBED) {
    ...
    try {
        ...
        LODOP.SET_LICENSES("赛默飞世尔（上海）仪器有限公司", "842368F109358B1DC9F723EB184D04F2", "賽默飛世爾（上海）儀器有限公司", "DFA394F42178BEED14E4DA6440820DD6");
        LODOP.SET_LICENSES("THIRD LICENSE", "", "Thermo Fisher Scientific (Shanghai) Instruments Co. Ltd,.", "B2D58689C049F40C101C36B19C1AFA28");
        //===========================================================
        return LODOP;
    } catch (err) {
        console.warn(err)
