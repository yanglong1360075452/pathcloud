...
(function () {
  ...
  function applicationForm() {
    var directive = {
      ...
      templateUrl: 'app/components/pathologicalForm/applicationForm/applicationForm.html',
      //replace:true,
    ...
    function applicationFormController($scope, $rootScope, SystemSettingService, $timeout, UserService, $filter, MaterialService, T, IhcService) {
      ...
      pathological.sexList = [/*{ name: T.T("请选择"), value: undefined },*/ {name: T.T("男"), value: 1}, {
        name: T.T("女"),
        value: 2
      }];
      pathological.maritalStatusList = [{name: T.T("请选择"), value: 90}, {name: T.T("未婚"), value: 10}, {
        name: T.T("已婚"),
        value: 20
      }, {name: T.T("丧偶"), value: 30}, {name: T.T("离婚"), value: 40},];
      ...
      pathological.menopauseList = [{name: T.T("请选择"), value: undefined}, {
        name: T.T("是"),
        value: true
      }, {name: T.T("否"), value: false}];
      ...
      console.info("申请表单数据",pathological);
