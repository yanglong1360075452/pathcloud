...
(function() {
  ...
  angular
    .module('pathcloud')
    .controller('DyeUseHistoryController', DyeUseHistoryController);

  /** @ngInject */
  function DyeUseHistoryController($scope,toolService,toastr,StatisticService,IhcService){
    var microcope = this;
    ...
    function init(){
     ...
     // 时间日期筛选部分 ===start===
      ...
      // // 冰冻预约表头
      microcope.tableHeaders=["染色机编号","使用人","使用时间","设备状态","备注"];
