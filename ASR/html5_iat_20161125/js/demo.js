...
var iflytek = (function (document) {
    ...
    var sessionStart = function () {
        var ssb_param = {
            "grammar_list": null,
            "params": "appid=582d9d3a,appidkey=fecc2626e4634729, lang = medical, acous = medical, aue=speex-wb;-1, usr = mkchen, ssm = 1, sub = iat, net_type = wifi, rse = utf8, ent =medical16k, rst = plain, auf  = audio/L16;rate=16000, vad_enable = 1, vad_timeout = 5000, vad_speech_tail = 500, compress = igzip"
        };
