package com.lifetech.dhap.pathcloud.dye.api;
...
@Ignore
public class DyeApiTest extends BaseTest{
     ...
     */
    @Test
    public void getSlideBySerialNumberTest() throws IllegalAccessException {
        ...
        for (DyeInfoVO div:dyeInfoVOS){
            assert (div != null);
            assert (div.getGrossingBody().equals("测试部位"));
            assert (div.getStatus().equals(PathologyStatus.PrepareDye.toCode()));
        }

    }

    @Test
    public void dyeConfirmTest() throws IllegalAccessException {
        ...
        for (ProductionVO productionVO:productionVOS){
            ...
            assert (productionVO.getBlockSerialNumber().equals(embedVO.getBlockSerialNumber()));
        }
